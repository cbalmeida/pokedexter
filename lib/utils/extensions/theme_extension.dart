...
class ThemeExt {
  ...
  static OutlinedButtonThemeData outlinedButtonTheme = OutlinedButtonThemeData(
    style: FilledButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)), minimumSize: const Size(80, 40), elevation: 1, backgroundColor: ColorExtension.primaryColor.withAlpha(35), side: const BorderSide(color: ColorExtension.primaryColor)),
  );
  ...
  static final lightTheme = ThemeData(
    ...
    scaffoldBackgroundColor: ColorExtension.primaryColor,
