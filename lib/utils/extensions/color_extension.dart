...
class ColorExtension {
  static const Color primaryColor = Color(0xffF10A34); //* Light
  ...
  static const Color secondaryBackgroundLight = Color(0xffF7F7F7);
  static const Color primaryTextLight = Colors.black;
  static const Color secondaryTextLight = Color(0xff555252);
  ...
  static const Color primaryColorDark = Color(0xffF10A34); //* Light
