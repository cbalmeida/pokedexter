...
extension ContextExtension on BuildContext {
  ...
  Color get primaryBgColor => Theme.of(this).brightness == Brightness.light ? ColorExtension.primaryBackgroundLight : ColorExtension.primaryBackgroundDark;

  Color get secondaryBgColor => Theme.of(this).brightness == Brightness.light ? ColorExtension.secondaryBackgroundLight : ColorExtension.secondaryBackgroundDark;
  ...
  Color get secondaryTextColor => Theme.of(this).brightness == Brightness.light ? ColorExtension.secondaryTextLight : ColorExtension.secondaryTextDark;
  ...
  InputDecorationTheme get inputDecorationThemePrimary => InputDecorationTheme(contentPadding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4), filled: true, focusColor: primaryColor, hoverColor: primaryColor.withOpacity(0.2), prefixIconColor: primaryColor);
}
